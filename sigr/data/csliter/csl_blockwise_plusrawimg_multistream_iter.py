...
class CSLBlockWisePlusRawImgMultiStreamData(mx.io.NDArrayIter):
...
#        self.num_channel = 1    
        ...
        super(CSLBlockWisePlusRawImgMultiStreamData, self).__init__(*args, **kargs)
...
#             kk = kk.reshape(kk.shape[0], shape_1, shape_2, shape_3)             
    ...
    def reset(self):
        self._reset()
        super(CSLBlockWisePlusRawImgMultiStreamData, self).reset()
