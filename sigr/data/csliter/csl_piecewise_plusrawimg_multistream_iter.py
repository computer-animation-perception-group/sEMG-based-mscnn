...
class CSLPieceWisePlusRawImgMultiStreamData(mx.io.NDArrayIter):
...
#        self.num_channel = 1    
        ...
        super(CSLPieceWisePlusRawImgMultiStreamData, self).__init__(*args, **kargs)
...
#             res = [a.reshape(a.shape[0], a.shape[1], -1) for a in res]  
    ...
    def reset(self):
        self._reset()
        super(CSLPieceWisePlusRawImgMultiStreamData, self).reset()
