...
class CapgMyoBlockWiseMultiStreamData_V2(mx.io.NDArrayIter):
...
#        self.num_channel = 1    
        ...
        super(CapgMyoBlockWiseMultiStreamData_V2, self).__init__(*args, **kargs)

#        self.num_channel = []
#        self.num_stripe = self.num_semg_row*2
#        self.shapes = []        
#        for i in range(self.num_stripe):
#            self.num_channel.append(self.window)
#            self.shapes.append(int(self.num_semg_col/2))
...
#                assert (self.batch_size // batch_size) % self.num_subject == 0
    ...
    def reset(self):
        self._reset()
        super(CapgMyoBlockWiseMultiStreamData_V2, self).reset()
