...
class CapgMyoSingleFrameMultiStreamData(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(CapgMyoSingleFrameMultiStreamData, self).__init__(*args, **kargs)
...
#             print res[0].shape    
    ...
    def reset(self):
        self._reset()
        super(CapgMyoSingleFrameMultiStreamData, self).reset()
