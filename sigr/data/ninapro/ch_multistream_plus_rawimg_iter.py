...
class ChMultiStreamPlusRawImgData(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(ChMultiStreamPlusRawImgData, self).__init__(*args, **kargs)
        ...
        for i in range(total_ch):
            ...
            self.shapes2.append(self.window)
...
#        print data.shape
    ...
    def _getdata(self, data_source):
        ...
        if data_source is self.data:       
             ...
             kk = res[0]
             res2 = []    
             res2.append(kk.reshape(kk.shape[0], 1, -1, kk.shape[1]))                          
    ...
    def reset(self):
        self._reset()
        super(ChMultiStreamPlusRawImgData, self).reset()
