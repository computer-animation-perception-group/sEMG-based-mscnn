...
class SigImgRawImgMultiStreamData(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(SigImgRawImgMultiStreamData, self).__init__(*args, **kargs)
        ...
        shape_1 = len(genIndex(self.num_semg_col*self.num_semg_row))-1
        shape_2 = self.num_semg_col*self.num_semg_row        
...
#             print res[0].shape
             ...
             res_1 = [self._get_sigimg(a.asnumpy() if isinstance(a, mx.nd.NDArray) else a) for a in res]
...
#             assert (res[0].shape[3] == self.shape_1)
    ...
    def reset(self):
        self._reset()
        super(SigImgRawImgMultiStreamData, self).reset()
