...
class BlockMultiStreamData(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(BlockMultiStreamData, self).__init__(*args, **kargs)
        ...
        self.total_ch = self.num_semg_col*self.num_semg_row - self.ch_win_num + 1
...
#              end = start+self.ch_win_num       
              ...
              ch_data = ch_data.reshape(ch_data.shape[0], 1, -1, ch_data.shape[2])
              res.append(ch_data)              
        return res      
    ...
    def reset(self):
        self._reset()
        super(BlockMultiStreamData, self).reset()
