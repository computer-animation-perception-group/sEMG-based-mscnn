...
#    feature_extraction_winstride = constant.FEATURE_EXTRACTION_WIN_STRIDE   
    ...
    semg_root = '/home/weiwentao/data/ninapro-db1/data' 
#    semg_root = None


    feature_root = ('/home/weiwentao/data/ninapro-db1-var-raw-prepro-lowpass-win-%d-stride-%d/' % (feature_extraction_winlength, 
