...
class FeatureRawImgMultiStreamData(mx.io.NDArrayIter):
    ...
    def __init__(self, *args, **kargs):
        ...
        super(FeatureRawImgMultiStreamData, self).__init__(*args, **kargs)
...
#        res = res.reshape(res.shape[0], res_axis_1, res_axis_2)
        ...
        res = res.reshape(res.shape[0], 1, self.feature_dim, self.num_semg_row*self.num_semg_col)      
...
#             assert (res[0].shape[3] == self.shape_1)
    ...
    def reset(self):
        self._reset()
        super(FeatureRawImgMultiStreamData, self).reset()
