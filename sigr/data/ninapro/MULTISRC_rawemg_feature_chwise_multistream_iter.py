...
class ChwiseRawIMGFeatureMultiStreamIter(mx.io.NDArrayIter):
...
#        self.feature_list = kargs.pop('feature_list')
        ...
        super(ChwiseRawIMGFeatureMultiStreamIter, self).__init__(*args, **kargs)
...
#             kk = res[0]
    ...
    def reset(self):
        self._reset()
        super(ChwiseRawIMGFeatureMultiStreamIter, self).reset()
