...
#            index.append(np.arange(n, n + len(seg)))
    ...
    def get_one_fold_intra_subject_forsoftmaxgenerating(self, fold, batch_size, feature_name, window, num_semg_row, num_semg_col, preprocess=None, **kargs):
        get_trial = self.get_trial_func(self.gestures, self.trials, preprocess=preprocess)
        load = partial(self.get_dataiter,
                       last_batch_handle='pad',
                       get_trial=get_trial,
