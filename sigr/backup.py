...
#            )
        ...
        net = self.get_fc(prefix + 'bottleneck', net, 64, no_bias=self.no_bias)
        net = get_act(prefix + 'bottleneck', net)
        out[prefix + 'bottleneck'] = net
...
#            net = mx.symbol.Reshape(net, shape=(0,-1,0,semg_col))  
...
#                feature = self.get_bn('fusion_pre_zscore', feature)               
                ...
                feature = mx.symbol.Reshape(feature, shape=(-1, 1, num_bottleneck, num_stream))
